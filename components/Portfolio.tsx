...
const Portfolio = () => {
  ...
  return (
    <section id="portfolio" className="pt-24 pb-20 sm:pt-28 sm:pb-24 lg:pt-32 lg:pb-28 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2 className="font-poppins text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 text-balance leading-[1.1]">
        ...
        >
          {portfolioItems.map((item, index) => (
            ...
            >
              {/* Image Container */}
              <div className="relative overflow-hidden rounded-lg sm:rounded-xl shadow-lg mb-4 sm:mb-6">
                <Image
                  src={item.image}
              ...
              <div className="space-y-3">
                ...
                <h3 className="font-poppins text-lg sm:text-xl font-bold text-gray-900 group-hover:text-[#E07A5F] transition-colors duration-300">
                  {item.title}
                </h3>
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="card-professional max-w-3xl mx-auto">
            ...
            <h3 className="font-poppins text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 text-balance">
              Your Business <span className="gradient-text">Deserves This Too</span>
            </h3>
            
            <p className="font-inter text-gray-700 mb-6 sm:mb-8 text-base sm:text-lg leading-relaxed max-w-2xl mx-auto text-balance">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
                              <a
                  href="#pricing"
                  className="btn-primary py-3 sm:py-4 px-6 sm:px-8 text-base sm:text-lg inline-flex items-center gap-3 group w-full sm:w-auto justify-center"
                >

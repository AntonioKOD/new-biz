      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="flex flex-col lg:flex-row items-center lg:items-center gap-16 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            {/* Enhanced Social Proof without Stats */}
            <div className="pt-8 border-t border-gray-100">
              <TextReveal delay={1200} className="mb-6">
                <div className="p-6 bg-gradient-to-r from-[#E07A5F]/5 to-[#D4A373]/5 rounded-xl border border-[#E07A5F]/10">
                  <blockquote className="text-lg italic text-gray-900 font-inter mb-3">
                    &ldquo;Working with this team felt like having a friend who just happens to be amazing at web design. They listened to my vision and brought it to life in ways I never imagined.&rdquo;
                  </blockquote>
                  <p className="text-sm text-gray-600 font-inter">— Sarah Chen, Boutique Owner</p>
                </div>
              </TextReveal>
              ...
              <TextReveal delay={1400}>
                <div className="flex justify-center lg:justify-start items-center space-x-6">
                  ...
                  <span className="text-sm text-gray-900 font-inter font-semibold">
                    Join businesses who&apos;ve found their perfect digital home
                  </span>
                </div>
              </TextReveal>
            </div>
